...
const Connect = () => {
  return (
    <div className="w-full flex flex-col justify-between space-y-12 lg:space-y-0 lg:flex-row">
                <img alt="Let's Connect" src={Star} className='lg:w-auto mx-auto absolute top-0 left-10' /> 
                <div className='flex flex-wrap justify-between items-end w-full'>
                    <h3 className="text-white text-2xl">Let's <br />Work <span className='text-[#3B9DF8]'>Together</span></h3>
                    <p className='w-auto'>
