...
import Bhogul from '../../assets/Favicon copy.webp'

const BlogComp = () => {
  return (
    <div className="w-full">
            <img alt="product/image" src={Bhogul} className='lg:w-24 w-44 mx-auto' />
            <h6 className="text-base md:text-xs font-normal mt-12 text-[#bcbcbc] uppercase tracking-wider">
                Blog</h6>
            <div className='flex flex-wrap justify-between items-center'>
                <h3 className="text-white text-2xl mt-2">Bhogul Tech</h3>
