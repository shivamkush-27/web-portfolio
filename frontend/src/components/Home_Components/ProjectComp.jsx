...
const ProjectComp = () => {
    return (
        <div className="w-full">
            <Clock />
            <h6 className="text-base md:text-xs font-normal mt-6 text-[#bcbcbc] uppercase tracking-wider">
                Showcase</h6>
            <div className='flex flex-nowrap justify-between items-center'>
                <h3 className="text-white xl:text-2xl text-lg mt-2">My Projects</h3>
