import { htmlImg, cssImg, jsImg, elementorImg, githubImg, bootstrapImg, tailwindImg, reactImg, vscodeImg, woocommerceImg } from '../assets/tech-img';

export const SkillInfo = [
    {icon: htmlImg, name: "HTML5", rating:"100%"},
    {icon: cssImg, name: "CSS3", rating:"100%"},
    {icon: bootstrapImg, name: "Bootstrap", rating:"100%"},
